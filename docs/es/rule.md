...
<table>
    <tr>
        <th colspan="5">Si Pagetual te resulta útil y te lo puedes permitir, agradeceríamos mucho una propina para financiar su desarrollo. Si no, no te preocupes, ¡disfrútalo! 💞</th>
    </tr>
    <tr>
...
[Más ejemplos de reglas](https://github.com/hoothin/UserScripts/blob/master/Pagetual/pagetualRules.json)
