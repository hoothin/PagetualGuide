---
sidebar: false
title: 🎉 Bienvenido a Pagetual
---
<section class="fr-hero">
  <div class="fr-hero__title">🎉 Bienvenido a Pagetual</div>
  <div class="fr-hero__subtitle">Instalación completa. Sigue esta lista para empezar con seguridad.</div>
  <div class="fr-hero__meta">
    <span class="fr-badge">Primer inicio</span>
    <span class="fr-dot"></span>
    <span class="fr-muted">Enfoque en seguridad</span>
  </div>
</section>

<section class="fr-card">
  <div class="fr-card__title">Lista de verificación</div>
  <ol class="fr-list">
    <li>Lee la guía de usuario para conocer lo básico.</li>
    <li><strong>Importa un set de reglas online. Las reglas pueden ejecutar código; usa solo fuentes confiables.</strong></li>
  </ol>
</section>
...
<section class="fr-callout">
  <div class="fr-callout__title">Nota de seguridad</div>
  <div class="fr-callout__body">Las reglas pueden ejecutar código. Verifica la fuente antes de importar.</div>
</section>
...
<section class="fr-grid">
  <div class="fr-card fr-card--mini">
    <div class="fr-card__title">Comunidad y novedades</div>
    <div class="fr-text">Actualizaciones, comentarios y soporte comunitario.</div>
    <div class="fr-links">
  ...
  <div class="fr-card fr-card--mini">
    <div class="fr-card__title">Soporte y servicios</div>
    <div class="fr-text">Proyectos web, juegos y apps: <a href="mailto:rixixi@gmail.com">rixixi@gmail.com</a></div>
  </div>
</section>

<section class="fr-card fr-card--video">
  <div class="fr-card__title">Guía en video</div>
...
<div class="fr-cta">
  <a class="fr-cta__btn" href="/es/usage">Empezar</a>
</div>
