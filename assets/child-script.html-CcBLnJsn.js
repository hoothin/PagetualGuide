import{_ as n,o as s,c as a,b as t}from"./app-glG3KbNp.js";const p={},e=t(`<h1 id="child-script" tabindex="-1"><a class="header-anchor" href="#child-script" aria-hidden="true">#</a> child script</h1><blockquote><p>如果站点限制代码 eval，可在子脚本里把函数挂到 window 对象下。</p></blockquote><h2 id="示例-1-当前站点单条规则" tabindex="-1"><a class="header-anchor" href="#示例-1-当前站点单条规则" aria-hidden="true">#</a> 示例 1：当前站点单条规则</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// ==UserScript==</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>单条规则时脚本本身已包含过滤条件，可省略 url。</p></blockquote><h2 id="示例-2-多站点规则集合" tabindex="-1"><a class="header-anchor" href="#示例-2-多站点规则集合" aria-hidden="true">#</a> 示例 2：多站点规则集合</h2><div class="language-javascript line-numbers-mode" data-ext="js"><pre class="language-javascript"><code><span class="token comment">// ==UserScript==</span>
