...
<table>
    <tr>
        <th colspan="5">Si vous trouvez Pagetual utile et que vous pouvez vous le permettre, un pourboire pour aider à financer son développement serait très apprécié. Si ce n'est pas le cas, ne vous inquiétez pas, profitez-en !💞</th>
    </tr>
    <tr>
...
[Plus d'exemples de règles](https://github.com/hoothin/UserScripts/blob/master/Pagetual/pagetualRules.json)
