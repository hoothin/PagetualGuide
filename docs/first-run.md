---
sidebar: false
title: Welcome to Pagetual
---
<section class="fr-hero">
  <div class="fr-hero__title">Welcome to Pagetual</div>
  ...
  <div class="fr-hero__meta">
    ...
    <span class="fr-muted">Import rules</span>
  </div>
</section>
...
<section class="fr-card">
  ...
  <ol class="fr-list">
    ...
    <li><strong>Import an online rule set.</strong> Online rules can execute code. Only import rules from sources you trust, especially if they’re unofficial.</li>
  </ol>
</section>
