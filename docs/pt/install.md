...
Pagetual é baseado no Greasemonkey, então ele requer um gerenciador de scripts para ser executado.
...
::: details 💡 P: O que é um "script Greasemonkey de navegador"?
...
R: Porque o Pagetual possui poderosos recursos de execução de código personalizado, e as extensões têm restrições nos recursos de execução de código personalizado por motivos de segurança. Além disso, os userscripts são mais flexíveis e podem ser executados em quase qualquer sistema operacional, como Windows/MAC/iOS/Android.
:::

::: details 💡 P: Os userscripts são seguros?
R: Os userscripts em si não são maliciosos, mas a segurança depende dos scripts que você escolhe instalar. Recomenda-se obter scripts apenas de fontes confiáveis e ler o código do script cuidadosamente.
:::
...
R: Você pode desabilitar ou excluir scripts Grease Monkey específicos na interface de gerenciamento do plug-in de userscript. Você também pode desabilitar temporariamente todo o plug-in do Script Manager para interromper a execução de todos os scripts.
:::
